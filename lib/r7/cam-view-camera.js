...
function setTwoFrustumCameras() {
	...
	camera2.position.set( 0, - 2 * RAD.meshes.userData.radius , 0 );
	camera2.up.set( 0, 0, 1 );

	camera2.userData.currentPosition = camera2.position.clone();
	camera2.userData.currentTarget = RAD.meshes.userData.center;
	camera2.near = 1 + Math.floor( 0.1 * RAD.meshes.userData.radius );
	camera2.far = parseInt( 5 * RAD.meshes.userData.radius, 10 );
	...
	controls2.target.copy( RAD.meshes.userData.center );
