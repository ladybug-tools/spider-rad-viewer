...
POP.getPopUpHtml = function() {
	...
	POP.particle.scale.x = POP.particle.scale.y = 0.03 * RAD.meshes.userData.radius;
...
POP.onDocumentMouseDown = function( event ) {
	...
	POP.mouse.x = ( event.clientX / THR.renderer.domElement.width ) * 2 - 1;
	POP.mouse.y = - ( event.clientY / THR.renderer.domElement.height ) * 2 + 1;
