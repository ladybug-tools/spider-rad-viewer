...
CUT.getDetSectionViews = function() {
	...
	`
		...
		<p>
			<button id=butSectionViewX onclick=CUT.toggleSectionViewX() >Toggle section view</button>
		</p>
		...
		<div>
			Clipping plane front: <output id=outClipY1 >50</output><br>
		...
		<div>
			Clipping plane back: <output id=outClipY2 >-50</output><br>
		...
		<div>
			Clipping plane front: <output id=outClipZ1 >50</output><br>
		...
		<div>
			Clipping plane back: <output id=outClipZ2 >-50</output><br>
...
CUT.updateCLipX = function() {
	...
	orig= THRU.axesHelper.position.x;
...
CUT.toggleSectionViewX = function() {
	...
	if ( butSectionViewX.style.fontStyle !== 'italic' ) {
		...
		RAD.meshes.traverse( function ( child ) {
		...
		butSectionViewX.style.cssText = 'background-color: ' + CUT.colorButtonToggle + ' !important; font-style: italic; font-weight: bold';
